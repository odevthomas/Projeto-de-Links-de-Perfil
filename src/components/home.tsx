...
function Home() {
  return (
    <div className="min-h-screen bg-black text-white pb-16 relative overflow-hidden z-10">
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-0 left-0 w-96 h-96 bg-blue-900 rounded-full filter blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-red-800 rounded-full filter blur-3xl"></div>
      </div>
        <BentoGrid />
    </div>
  );
